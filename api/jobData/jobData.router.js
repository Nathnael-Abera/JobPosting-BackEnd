...
const { createJob, getJob,getAllJob, updateJob, deleteJob,filterJobs,getSortedJob,getJobById,getSortByDate} = require('./jobData.controller')
...
router.route('/all').get(auth,getAllJob)
